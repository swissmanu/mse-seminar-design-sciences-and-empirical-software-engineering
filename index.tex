...
With the outlook Salvaneschi et al. conclude the result evaluation with multiple suggestions for follow-up research.
...
\begin{itemize}
	...
	\item \textbf{Critique 3: FAIR:Code samples or any additional artifacts are available. Reproducibility?}
	...
	\item \item \textbf{Check: Claim Page 12 Observer Pattern does not provide separation of concerns}
\end{itemize}
...
Cite page 13 about operator complexity... Own experience: Yes, it is cumbersome
