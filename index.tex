...
We can implement a solution facilitating a basic RP approach using the \mintinline{JavaScript}{Promise}\footnote{\url{https://www.ecma-international.org/ecma-262/6.0/\#sec-promise-objects}} API available in modern JavaScript runtime environments as exemplified in listing \ref{lst:case-for-rp-rp}.
...
\begin{listing}[H]
	...
	\label{lst:case-for-rp-observer}
\end{listing}




\subsection{Event Handling: A Case for the Observer Pattern}
