...
The \emph{interactive application} \cite{Salvaneschi:2014:ESP:2635868.2635895} described in the second scenario is rather simple in its formulation, though represents the recurring common task of handling user interaction events when building a frontend application:
