...
As the paper further compares RP with the observer design pattern \cite{gamma1995design}, an equivalent based on object oriented programming \emph{(OOP)} paradigms, question set \textbf{Q2} reviews software engineering specific aspects of that comparison:
...
\section{Paper Revisit (Q1 and R2.1)}
...
The group used the study to confirm results presented earlier in 2014. With an additional 89 subjects, the new experiment was conducted with a total of 127 subjects.
